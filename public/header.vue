          ...
          <div class="main__header header__sticky"  >
              <div class="container" >
                  <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                      ...
                      <div class="main__logo" style="width: 101px;
                      height: 41px;
                      position: relative;
                      left: -90px; ">
                      ...
                      <div class="header__menu-panel" style="display: inline-flex; padding: 5px 15px; align-items: center; gap: 15px;">
                          <button class="menu-panel__button_first" style="color: #F00; font-family: Montserrat; font-size: 16px; font-style: normal; font-weight: 500; line-height: normal; letter-spacing: -0.48px;">Акции</button>
                          <button class="menu-panel__button" style="  font-family: Montserrat; font-size: 16px; font-style: normal; font-weight: 500; line-height: normal; letter-spacing: -0.48px;">Button </button>
                          <button class="menu-panel__button" style="  font-family: Montserrat; font-size: 16px; font-style: normal; font-weight: 500; line-height: normal; letter-spacing: -0.48px;">Button </button>
                          <button class="menu-panel__button"style="  font-family: Montserrat; font-size: 16px; font-style: normal; font-weight: 500; line-height: normal; letter-spacing: -0.48px;">Button </button>
                          <button class="menu-panel__button"style="  font-family: Montserrat; font-size: 16px; font-style: normal; font-weight: 500; line-height: normal; letter-spacing: -0.48px;">Button </button>
                          
                          <!-- Добавьте еще кнопки, если нужно -->
                      </div>
                      <div class="panel" id="myPanel">
                          <img src="assets\img\icon\metka-gorod 1.svg" alt="Icon">
                          <div class="label">Надпись</div>
                          <button onclick="toggleDropdown()" src="assets\img\icon\Vector 1.svg" style=" width: 20px; /* ваш желаемый размер по горизонтали */
                          height: 10px; /* ваш желаемый размер по вертикали */"> </button>
                        ...
                        <div class="panel-right">
                          ...
                          <div class="label">+38 097 295 88 03</div>
                        </div>
                        <!-- Новая третья панель -->
    <div class="logo-messengers">
      <img src="assets\img\icon\viber-top.svg" alt="Messenger Icon 1">
      <img src="assets\img\icon\wats-app-top.svg" alt="Messenger Icon 2">
      <img src="assets\img\icon\telegram-top.svg" alt="Messenger Icon 3">
    </div>
           ...
           <div class="header__bottom bg__primary">
              <div class="container">
                  <div class="header__bottom--inner position__relative d-flex align-items-center"  >
                      <div class="categories__menu mobile-v-none" style="  
                      position: relative;
    left: -100px;
                      ">
                      ...
                      <div class="header__search--widget d-none d-lg-block header__sticky--none"  style="  
                      position: relative;left: -100px; ">
                          <form class="d-flex header__search--form border-radius-5" action="#">
                              
                              <div class="header__search--box">
                                  <label>
                                      <input class="header__search--input" placeholder="Поиск товара" svg="assets\img\icon\lupa 1.svg" >
                                  </label>
                      ...
                      <div class="frame3-panel">
                          <button class="icon-button">
                              <img src="assets\img\icon\logo-korzina.svg" alt="Корзина">
                          </button>
                          <button class="icon-button">
                              <img src="assets\img\icon\logo-kabinet.svg" alt="Личный кабинет">
                          </button>
                          <button class="icon-button">
                              <img src="assets\img\icon\logo-izbranoe.svg" alt="Избранное">
                          </button>
                          <button class="icon-button">
                              <img src="assets\img\icon\logo-sravnenie.svg" alt="Сравнение">
                          </button>
                      </div>
              ...
              <div class="vertical-block" style="margin-left: 100px; ">
                  <div class="item" onclick="handleItemClick('Item 1') ">
                      <img src="path/to/logo1.png" alt="Logo 1">
                      <p>Item 1</p>
                  </div>
                  <div class="item" onclick="handleItemClick('Item 2')">
  ...
  <div class="offcanvas__stikcy--toolbar">
      <ul class="d-flex justify-content-between">
          <li class="offcanvas__stikcy--toolbar__list">
              <a class="off-canvas__sticky--toolbar__btn" href="../templates/index.html">
          ...
          <li class="offcanvas__stikcy--toolbar__list">
              <a class="off-canvas__sticky--toolbar__btn" href="shop.html">
              <span class="offcanvas__stikcy--toolbar__icon"> 
          ...
          <li class="offcanvas__stikcy--toolbar__list ">
              <a class="off-canvas__sticky--toolbar__btn search__open--btn" href="javascript:void(0)" data-offcanvas>
                  <span class="offcanvas__stikcy--toolbar__icon"> 
          ...
          <li class="offcanvas__stikcy--toolbar__list">
              <a class="off-canvas__sticky--toolbar__btn minicart__open--btn" href="javascript:void(0)" data-offcanvas>
                  <span class="offcanvas__stikcy--toolbar__icon"> 
          ...
          <li class="offcanvas__stikcy--toolbar__list">
              <a class="off-canvas__sticky--toolbar__btn" href="wishlist.html">
                  <span class="offcanvas__stikcy--toolbar__icon"> 
 ...
 export default {
  props: {
    ...
    window.onclick = function(event) {
      if (!event.target.matches('.panel button')) {
...
.panel-container {
  ...
  margin: 10px; /* Добавлено небольшое поле между панелями и краями */
}
/* Стили для слайдера */
.swiper-container {
  width: 878px;
...
.swiper-slide {
  ...
  font-size: 18px;
  background: #fff;
  /* Дополнительные стили для слайдов, если необходимо */
}
.horizontal-buttons {
  display: flex;
  width: 1172px;
...
.panel {
  ...
  overflow: hidden;
  position: relative;
  margin-right: 12px; /* Добавлен отступ справа между панелями */
}
...
.panel .icon {
  ...
  height: 5px;
  flex-shrink: 0;
  background: url('your_icon_url.png') no-repeat center center;
...
/* Добавлена новая стилизация для правой панели */
.panel-right {
  display: flex;
  width: 200px;
  height: 20.5px;
...
/* Новая стилизация для третьей панели */
.logo-messengers {
  display: flex;
  width: 200px;
  height: 20.5px;
  justify-content: flex-end; /* Иконки выравниваются вправо */
  align-items: center;
  flex-shrink: 0;
  border: 1px solid #ccc;
  border-radius: 5px;
...
.off-canvas__sticky--toolbar__btn {
  position: relative;
  text-align: center;
}

.off-canvas__sticky--toolbar__btn:hover .offcanvas__stikcy--toolbar__icon {
  background: var(--secondary-color);
...
.off-canvas__sticky--toolbar__btn.minicart__open--btn {
  -webkit-box-orient: vertical;
